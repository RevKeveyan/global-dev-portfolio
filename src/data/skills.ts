...
export const skills: Skill[] = [
  ...
  { id: 'nextjs', labelKey: 'nextjs', category: 'frontend', icon: 'triangle', demoType: 'nextjs', color: '#FFFFFF' },
  { id: 'tailwind', labelKey: 'tailwind', category: 'frontend', icon: 'palette', demoType: 'tailwind', color: '#06B6D4' },
  { id: 'redux', labelKey: 'redux', category: 'frontend', icon: 'layers', demoType: 'redux', color: '#764ABC' },

  // UI/UX
  { id: 'figma', labelKey: 'figma', category: 'ui', icon: 'figma', demoType: 'figma', color: '#F24E1E' },
  { id: 'framer', labelKey: 'framer', category: 'ui', icon: 'sparkles', demoType: 'framer', color: '#BB4DFF' },

  // Vue Ecosystem
  { id: 'vue', labelKey: 'vue', category: 'vue', icon: 'component', demoType: 'vue', color: '#4FC08D' },
  { id: 'nuxt', labelKey: 'nuxt', category: 'vue', icon: 'hexagon', demoType: 'nuxt', color: '#00DC82' },
  { id: 'pinia', labelKey: 'pinia', category: 'vue', icon: 'database', demoType: 'pinia', color: '#FFD859' },
  ...
  // Data
  { id: 'postgresql', labelKey: 'postgresql', category: 'data', icon: 'database', demoType: 'postgresql', color: '#336791' },
  { id: 'mongodb', labelKey: 'mongodb', category: 'data', icon: 'leaf', demoType: 'mongodb', color: '#47A248' },
  ...
  { id: 'kubernetes', labelKey: 'kubernetes', category: 'devops', icon: 'network', demoType: 'kubernetes', color: '#326CE5' },
  { id: 'aws', labelKey: 'aws', category: 'devops', icon: 'cloud', demoType: 'aws', color: '#FF9900' },

  // Tooling
  { id: 'git', labelKey: 'git', category: 'tooling', icon: 'git-branch', demoType: 'git', color: '#F05032' },
  { id: 'webpack', labelKey: 'webpack', category: 'tooling', icon: 'package', demoType: 'webpack', color: '#8DD6F9' },
  { id: 'vite', labelKey: 'vite', category: 'tooling', icon: 'bolt', demoType: 'vite', color: '#646CFF' },

  // Platforms
  { id: 'vercel', labelKey: 'vercel', category: 'platforms', icon: 'triangle', demoType: 'vercel', color: '#FFFFFF' },
